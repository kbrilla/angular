...
import {
  ...
  MARKDOWN_FENCES,
  STYLE_TOKEN_PARITY_COMPONENT,
  STYLE_TOKEN_PARITY_INLINE_COMPONENT,
  STYLE_TOKEN_PARITY_TEMPLATE,
} from '../test_constants';
...
export const STYLE_TOKEN_PARITY_COMPONENT_URI = vscode.Uri.file(STYLE_TOKEN_PARITY_COMPONENT);
export const STYLE_TOKEN_PARITY_INLINE_COMPONENT_URI = vscode.Uri.file(
  STYLE_TOKEN_PARITY_INLINE_COMPONENT,
);
export const STYLE_TOKEN_PARITY_TEMPLATE_URI = vscode.Uri.file(STYLE_TOKEN_PARITY_TEMPLATE);
