...
export function getInlayHintsForTemplate(
  ...
  /**
   * Map of DOM event names to their precise event types.
   * Used to provide accurate type hints for DOM event bindings.
   * Based on HTMLElementEventMap from lib.dom.d.ts.
   */
  const DOM_EVENT_TYPE_MAP: Record<string, string> = {
