...
export enum FixIdForCodeFixesAll {
  ...
  FIX_LEGACY_SAFE_NAVIGATION_USAGE_SAFE = 'fixLegacySafeNavigationUsageSafe',
  FIX_LEGACY_SAFE_NAVIGATION_USAGE_BEST_EFFORT = 'fixLegacySafeNavigationUsageBestEffort',
