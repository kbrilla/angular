...
describe('ARIA validation diagnostics', () => {
  ...
  describe('Invalid ARIA attribute value detection', () => {
    ...
    // TODO: Re-enable when empty string ARIA value handling is implemented
    xit('should accept empty string values (treated as undefined)', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
  ...
  describe('ARIA integer and number values', () => {
    ...
    // TODO: Re-enable when ARIA integer type validation is implemented
    xit('should reject non-integer values for aria-level', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
