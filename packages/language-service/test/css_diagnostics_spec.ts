...
describe('CSS property validation diagnostics', () => {
  ...
  describe('ngClass to class migration suggestions', () => {
    it('should suggest using [class] instead of [ngClass] for string expression', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
      ...
      const ngClassDiags = diags.filter(
        (d) => d.code === CssDiagnosticCode.PREFER_CLASS_OVER_NGCLASS,
      );
      expect(ngClassDiags.length).toBe(1);
      expect(ngClassDiags[0].messageText).toContain('Consider using [class] instead of [ngClass]');
      expect(ngClassDiags[0].category).toBe(ts.DiagnosticCategory.Suggestion);
    });

    it('should suggest using [class] instead of [ngClass] for object literal', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
          import {NgClass} from '@angular/common';
    ...
    it('should suggest using [class] instead of [ngClass] for array expression', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
          import {NgClass} from '@angular/common';
    ...
    it('should not suggest for [class] binding', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
      ...
      expect(ngClassDiags.length).toBe(0);
    });
  });

  describe('style object to individual bindings suggestions', () => {
    it('should suggest individual bindings for small style object literal', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
      ...
      const styleDiags = diags.filter(
        (d) => d.code === CssDiagnosticCode.PREFER_INDIVIDUAL_STYLE_BINDINGS,
      );
      expect(styleDiags.length).toBe(1);
      expect(styleDiags[0].messageText).toContain('Consider using individual style bindings');
      expect(styleDiags[0].category).toBe(ts.DiagnosticCategory.Suggestion);
    });

    it('should suggest individual bindings for single property object literal', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
    ...
    it('should suggest individual bindings for exactly 5 properties', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';

          @Component({
            template: '<div [style]="{width: w, height: h, color: c, margin: m, padding: p}"></div>',
          })
          export class AppComponent {
            w = '100px';
            h = '200px';
    ...
    it('should NOT suggest for style object with more than 5 properties', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';

          @Component({
            template: '<div [style]="{width: w, height: h, color: c, margin: m, padding: p, border: b}"></div>',
          })
          export class AppComponent {
            w = '100px';
            h = '200px';
      ...
      expect(styleDiags.length).toBe(0);
    });

    it('should NOT suggest for style object with spread operator', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';

          @Component({
            template: '<div [style]="{width: w, ...baseStyles}"></div>',
          })
          export class AppComponent {
            w = '100px';
    ...
    it('should NOT suggest for style binding with variable reference', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
    ...
    it('should NOT suggest for [style.property] bindings', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';

          @Component({
            template: '<div [style.width]="w"></div>',
          })
          export class AppComponent {
            w = '100px';
          }
  ...
  describe('individual style bindings to [style] object suggestions', () => {
    it('should suggest consolidating multiple individual style bindings', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
      ...
      const styleDiags = diags.filter(
        (d) => d.code === CssDiagnosticCode.PREFER_STYLE_OBJECT_BINDING,
      );
      expect(styleDiags.length).toBe(1);
      expect(styleDiags[0].messageText).toContain('3 individual style bindings');
      expect(styleDiags[0].category).toBe(ts.DiagnosticCategory.Suggestion);
    });

    it('should NOT suggest for only 2 style bindings (minimum is 3)', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';

          @Component({
            template: '<div [style.width]="w" [style.height]="h"></div>',
          })
          export class AppComponent {
            w = '100px';
            h = '200px';
    ...
    it('should NOT suggest when any binding uses a pipe', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';
      ...
      // Should NOT suggest because pipes cannot be used in object literals
      expect(styleDiags.length).toBe(0);
    });

    it('should NOT suggest when element already has [style] object binding', () => {
      const files = {
        'app.ts': `
          import {Component} from '@angular/core';

          @Component({
            template: '<div [style]="{margin: m}" [style.width]="w" [style.height]="h" [style.color]="c"></div>',
          })
          export class AppComponent {
            m = '10px';
            w = '100px';
      ...
      // Should NOT suggest because there's already a [style] object binding
      expect(styleDiags.length).toBe(0);
    });
  });
});
